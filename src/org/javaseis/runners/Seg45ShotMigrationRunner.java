...
public class Seg45ShotMigrationRunner {
	...
	public void programTerminates() throws FileNotFoundException {
		...
		String outputFileName = "seg45i2.js";
		...
		try {
			// shotNumber >= 0 specifies the shot number
			// shotNumber == -1 run in serial over all shots
			StandAloneVolumeTool.StandAloneVolumeTask.shotNumber = 0;
